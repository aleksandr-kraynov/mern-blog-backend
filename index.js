...
mongoose
  .connect('mongodb+srv://admin:qwerty123456@cluster0.rftekwh.mongodb.net/blog?retryWrites=true&w=majority')
...
app.get('/posts/:id/comment', checkAuth, CommentController.getComments);
